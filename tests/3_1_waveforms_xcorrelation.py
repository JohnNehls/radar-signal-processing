...
plot_pulse_and_spectrum(t_u, mag_u, f"S3P1 uncoded pulse {sampleRate=} {BW=}", Npad=500)
...
plot_pulse_and_spectrum(
    t_b, mag_b, f"S3P1 Barker coded pulse {nChip=} {sampleRate=} {BW=}", Npad=500
)
...
plot_pulse_and_spectrum(
    t_r, mag_r, f"S3P1 random coded pulse {nChip=} {sampleRate=} {BW=}", Npad=500
)
...
fig, ax = plot_pulse_and_spectrum(
    t_lfm, mag_lfm, f"S3P1 LFM pulse {chirpUpDown=} {T=}{sampleRate=} {BW=}", Npad=500
)
