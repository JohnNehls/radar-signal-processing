...
from rsp.waveform import makeUncodedPulse, makeBarkerCodedPulse, makeRandomCodedPulse, makeLFMPulse
...
nChip = 7
t_b, mag_b = makeBarkerCodedPulse(
...
nChip = 7
t_r, mag_r = makeRandomCodedPulse(
    sampleRate, BW, nChip, output_length_T=output_time_T, normalize=False
)
